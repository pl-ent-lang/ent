...
public class PandaLubType_c extends LubType_c implements PandaLubType {

  public PandaLubType_c(TypeSystem ts, Position pos, List<ReferenceType> lubElems) {
  ...
  private ReferenceType lci(List<ReferenceType> inv) {
    ...
    for (int i = 1; i < inv.size(); i++) {
      ...
      try {
        res = 
          (JL5SubstClassType) ts.instantiate(position, res.base(), lcta_args);
      }
      catch (SemanticException e) {
