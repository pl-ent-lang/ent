...
public abstract class EntAbstractExtFactory_c extends JL7AbstractExtFactory_c
        implements EntExtFactory {

    public EntAbstractExtFactory_c() {
        super();
    }

    public EntAbstractExtFactory_c(ExtFactory nextExtFactory) {
    ...
    protected Ext extAttributeDeclImpl() { 
      return extTermImpl();
    }

    protected Ext postExtAttributeDecl(Ext e) { 
    ...
    protected Ext extModeValueImpl() { 
      return extExprImpl();
    }

    protected Ext postExtModeValue(Ext e) { 
