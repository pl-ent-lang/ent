...
public abstract class ModeSubstClassType_c extends ModeSubstReferenceType_c implements ModeSubstClassType {
  ...
  public boolean hasAttribute() {
    return ((EntClassType) this.baseType()).hasAttribute();
  }

  public CopyInstance copyInstance() {
    return ((EntClassType) this.baseType()).copyInstance();
  }
  ...
  public boolean hasCopy() {
    return ((EntClassType) this.baseType()).hasCopy();
  }

  public boolean hasMcaseFields() {
    return ((EntClassType) this.baseType()).hasMcaseFields();
  } 
  ...
  public boolean hasDynamicRecv() {
    return ((EntClassType) this.baseType()).hasDynamicRecv();
  } 
