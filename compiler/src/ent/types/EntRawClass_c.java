...
public class EntRawClass_c extends RawClass_c implements EntRawClass {
  ...
  public EntRawClass_c(JL5ParsedClassType classType, Position pos) {
    super(classType, pos);
  }
  ...
  public boolean hasAttribute() {
    return ((EntParsedClassType) this.base()).hasAttribute();
  }

  public CopyInstance copyInstance() {
    return ((EntParsedClassType) this.base()).copyInstance();
  }
  ...
  public boolean hasCopy() {
    return ((EntParsedClassType) this.base()).hasCopy();
  } 
  
  public boolean hasMcaseFields() {
    return ((EntParsedClassType) this.base()).hasMcaseFields();
  } 
  ...
  public boolean hasDynamicRecv() {
    return ((EntParsedClassType) this.base()).hasDynamicRecv();
  } 
