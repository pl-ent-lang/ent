...
public class UnixBareMetalBattery implements BareMetalBattery {
  ...
  private static final String CURRENT_ENERGY_PATH = "/sys/class/power_supply/BAT0/energy_now";

  private static final String TOTAL_ENERGY_PATH = "/sys/class/power_supply/BAT0/energy_full";
