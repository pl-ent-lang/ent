...
public class Wrapper<T> implements Iterable<T> {
  ...
  public static void main(String[] args) {
    ...
    Wrapper<String@mode<low>> w1 = new Wrapper<String@mode<low>>("a", "b", "c", "d", "e");
    ...
    Wrapper<String@mode<high>> w2 = new Wrapper<String@mode<high>>("a", "b", "c", "d", "e");
    ...
    Wrapper< List< String@mode<low> >@mode<mid> > w2 = new Wrapper< List< String@mode<low> >@mode<mid> >(l1, l2, l3);
    ...
    for (List<String@mode>low> >@mode<mid> e : w2) {
      System.out.println(e);
    }
