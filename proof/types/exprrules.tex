      ...
      \\
        ...
        \Gamma;\cset \vdash e : \bt'   \\
		  ...
		  \inferrule*[left=\stitle{Msg}]
			{
			  \Gamma; \cset \vdash\ e: \objt   \\
			  \Fmtype(\Mname, \objt) = \overline{\bt}\rightarrow\bt \\
				\Gamma; \cset \vdash \overline{e}: \overline{\bt} \\
			  \Gamma; \cset \vdash\ \kwthis: \bt_{this}   \\
        \cset \models \{\Fmode(\objt)\msub\Fmode(\bt_{this})\} \\ \Fmode(\objt) \neq \ ?
		  }
			{\Gamma; \cset \vdash e.\Mname(\overline{e}): \bt }
			\\
			\inferrule*[left=\stitle{Field}]
			{
        \Gamma;\cset \vdash e : \objt  \\ \Gamma;\cset \vdash \kwthis : \bt_{this} \\
			  \Ffields(\objt) = \overline{\bt}\ \overline{\Fname} \\
        \cset \models \{\Fmode(\objt)\msub\Fmode(\bt_{this})\} \\ \Fmode(\classiota) \neq \ ? 
			}
...
%      \\
%      
			\inferrule*[left=\stitle{Snapshot1}]
			{ 
        \Gamma;\cset' \vdash e : \classdyn \\ 
        \econs = \basemode_1 \msub \mtvar \msub \basemode_2 \\ 
        \cset = \cset'\cup\{\basemode_1\msub\mtvar,\mtvar\msub\basemode_2\} \\
      }
			{
        \Gamma;\cset \vdash \snapshot{e}{\basemode_{1}}{\basemode_{2}} : \texist{\econs}.\classdyn
      }
      \\

      %\inferrule*[left=\stitle{Snapshot3}]
      %{ 
      %  \Gamma;\cset' \vdash e : \Cname \lb ?,\listi \rb \\ 
      %  \mtvar\ fresh \\
      %  \cset = \cset'\cup\{\basemode_1\msub\mtvar,\mtvar\msub\basemode_2\} \\
      %  \cset \judgewft \Cname\lb\mtvar,\listi\rb \\
      %}
      %{
      %  \Gamma;\cset \vdash \snapshot{e}{\basemode_{1}}{\basemode_{2}} : \Cname\lb\mtvar,\listi\rb
      %}
      %\\
