...
\rtitle{Check} & \checkp{\moname'}{\moname_1}{\moname_2}{\obj} & \cloreduct{\moname} & \closure{\alpha'}{\texist{\moname'}.\classdyn}{\overline{\val}} & \textrm {if} \ \moname_1\msub\moname'\msub\moname_2, \alpha'\ \textrm{is}\ fresh \\
